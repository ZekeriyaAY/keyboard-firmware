...
[_LOWER] = LAYOUT(
  ...
  _______, _______, _______, KC_BRID, KC_BRIU, _______, KC_F11,  KC_F12,  _______, KC_WH_D, KC_WH_U, _______, _______, _______,
...
[_RAISE] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______, TR_LABK, TR_RABK, _______, KC_WH_D, KC_WH_U, _______, _______, _______,
                             _______, _______, _______, _______, _______, _______, _______, _______
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
